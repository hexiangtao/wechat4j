...
public class PropertyReader {
	...
	/*
	 * private String getWildcard(String str) { if (null != str && str.indexOf("${")
	 * != -1) { int start = str.indexOf("${"); int end = str.indexOf("}"); if (start
	 * != -1 && end != -1) { return str.substring(start + 2, end); } } return null;
	 * }
	 */
