...
public class QiniuFileUploadKit {
	...
	public QiniuFileUploadKit(String ak, String secret, String bucket, UploadManager uploadManager) {
	...
	public QiniuFileUploadKit(String ak, String secret, String bucket) {
		this(ak, secret, bucket, null);
	}

	public QiniuFileUploadKit(String ak, String secret) {
		this(ak, secret, null, null);
	}

	public QiniuFileUploadKit() {
