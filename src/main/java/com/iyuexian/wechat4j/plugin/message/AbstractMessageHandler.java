...
import com.iyuexian.wechat4j.plugin.tuling123.TulingRobot;
import com.iyuexian.wechat4j.webweixin.util.QiniuFileUploadKit;
...
public abstract class AbstractMessageHandler implements IMessageHandler, TxtMessageRobot {
	...
	public boolean download(JSONObject msg, MsgType msgType) {
		...
		QiniuFileUploadKit kit = new QiniuFileUploadKit();
		String fileKey = kit.uploadToQiniu(bios.toInputStream(), "file." + ext);
